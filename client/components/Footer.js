            ...
            <div className="flex gap-2">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full bg-dark-700 border border-gray-700 text-white placeholder-gray-500 rounded-xl pl-9 pr-3 py-2.5 text-sm outline-none focus:border-primary-500 transition-colors"
                />
              </div>
